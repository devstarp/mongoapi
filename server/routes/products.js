...
class ProductsRoute {
	...
	getSingleOption(req, res, next) {
		ProductOptionsService.getSingleOption(req.params.productId, req.params.optionId)
			.then((data) => {
				if (data) {
					res.send(data);
				} else {
	...
	updateOption(req, res, next) {
		ProductOptionsService.updateOption(req.params.productId, req.params.optionId, req.body)
			.then((data) => {
				res.send(data);
			})
			.catch(next);
	...
	getOptionValues(req, res, next) {
		ProductOptionValuesService.getOptionValues(req.params.productId, req.params.optionId)
			.then((data) => {
				res.send(data);
			})
			.catch(next);
	...
	getSingleOptionValue(req, res, next) {
		ProductOptionValuesService.getSingleOptionValue(req.params.productId, req.params.optionId, req.params.valueId)
			.then((data) => {
				if (data) {
					res.send(data);
				} else {
	...
	addOptionValue(req, res, next) {
		ProductOptionValuesService.addOptionValue(req.params.productId, req.params.optionId, req.body)
			.then((data) => {
				res.send(data);
			})
			.catch(next);
	...
	deleteOptionValue(req, res, next) {
		ProductOptionValuesService.deleteOptionValue(req.params.productId, req.params.optionId, req.params.valueId)
			.then((data) => {
				res.send(data);
			})
			.catch(next);
	...
	updateVariant(req, res, next) {
		ProductVariantsService.updateVariant(req.params.productId, req.params.variantId, req.body)
			.then((data) => {
				res.send(data);
			})
			.catch(next);
	...
	deleteVariant(req, res, next) {
		ProductVariantsService.deleteVariant(req.params.productId, req.params.variantId)
			.then((data) => {
				res.send(data);
			})
			.catch(next);
	...
	setVariantOption(req, res, next) {
		ProductVariantsService.setVariantOption(req.params.productId, req.params.variantId, req.body)
			.then((data) => {
				res.send(data);
			})
			.catch(next);
